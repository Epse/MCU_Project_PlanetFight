...
\newcommand{\TODO}{\textcolor{red}{\large\textbf{TODO}}}
...
\begin{titlepage}
  ...
  \includegraphics[height=1cm]{afbeeldingen/iwa.png}
  \vspace{2cm}
  \vfill
  ...
  \includegraphics[height=3cm]{afbeeldingen/logo.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{afbeeldingen/schijf.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{afbeeldingen/scoopcontrolesc.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{afbeeldingen/scoopesc.png}
